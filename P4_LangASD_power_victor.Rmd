...
powerV = powerSim(TypesModel, fixed("VISIT", method = T) nsim=200) #keep getting error. 
powerV #98-100, effect size = 0.47 

power2 = powerSim(TypesModel, fixed("verbalIQ_1", method = T), nsim=200) #t-test. 
power2 #98-100, effect size = 0.061

power3 = powerSim(TypesModel, fixed("MOT_MLU", method = T), nsim=200)
power3 #98-100, effect size = 0.35
save(power3, file="power3.RData")

power4 = powerSim(TypesModel, fixed("tokens_MOT", method = T), nsim=200)
